...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ \"./node_modules/lodash/lodash.js\");\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _List_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./List.vue */ \"./src/monitor/components/traffic/List.vue\");\n/* harmony import */ var copy_to_clipboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! copy-to-clipboard */ \"./node_modules/copy-to-clipboard/index.js\");\n/* harmony import */ var copy_to_clipboard__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(copy_to_clipboard__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _context_menu_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../context-menu/index */ \"./src/context-menu/index.js\");\n/* harmony import */ var _context_menu_index__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_context_menu_index__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _api_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../api/data */ \"./src/api/data.js\");\n/* harmony import */ var _httptraffic_pcss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./httptraffic.pcss */ \"./src/monitor/components/traffic/httptraffic.pcss\");\n/* harmony import */ var _httptraffic_pcss__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_httptraffic_pcss__WEBPACK_IMPORTED_MODULE_5__);\n/* harmony import */ var _record_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./record.vue */ \"./src/monitor/components/traffic/record.vue\");\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n\n\n\n\n\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  props: ['height'],\n  components: {\n    List: _List_vue__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n    ContextMenu: _context_menu_index__WEBPACK_IMPORTED_MODULE_3___default.a,\n    Record: _record_vue__WEBPACK_IMPORTED_MODULE_6__[\"default\"]\n  },\n  data: function data() {\n    return {};\n  },\n  methods: {\n    // -------------------------------菜单操作\n    saveData: function saveData() {\n      var _this = this;\n\n      if (!this.$dc.rightClickRow.response) {\n        this.$message({\n          showClose: true,\n          message: '服务器还没有响应',\n          type: 'warning'\n        });\n        return;\n      }\n\n      this.$prompt('请输入数据文件名', '保存为数据文件', {\n        confirmButtonText: '确定',\n        cancelButtonText: '取消'\n      }).then(function (_ref) {\n        var value = _ref.value;\n        _api_data__WEBPACK_IMPORTED_MODULE_4__[\"default\"].saveDataEntryFromTraffic(_this.$dc.rightClickId, value, _this.$dc.rightClickRow.response.headers['content-type'].split(';')[0]).then(function (res) {\n          var serverData = res.data;\n\n          if (serverData.code == 0) {\n            _this.$message({\n              showClose: true,\n              type: 'success',\n              message: '保存成功!'\n            });\n          } else {\n            _this.$message.error(\"\\u51FA\\u9519\\u4E86\\uFF0C\".concat(serverData.msg));\n          }\n        });\n      });\n    },\n    // 复制url\n    copyUrl: function copyUrl() {\n      var requset = this.$dc.rightClickRow.originRequest;\n      copy_to_clipboard__WEBPACK_IMPORTED_MODULE_2___default()(\"\".concat(requset.protocol, \"//\").concat(requset.host, \":\").concat(requset.port).concat(requset.path));\n      this.$message('已将url复制到剪切板');\n    },\n    // -------------------------------右击菜单显示\n    // 打开菜单\n    onCtxOpen: function onCtxOpen(recordId) {\n      this.$dc.setRightClickedRecordId(recordId);\n    },\n    rightClicked: function rightClicked(event, recordId) {\n      this.$refs.ctx.open(event, recordId);\n    },\n    // 点击菜单选项\n    onCtxClose: function onCtxClose(locals) {},\n    // 点击空白地方\n    resetCtxLocals: function resetCtxLocals() {\n      this.$dc.setRightClickedRecordId('');\n    }\n  }\n});\n\n//# sourceURL=webpack:///./src/monitor/components/traffic/HttpTraffic.vue?./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/**\n * Created by tsxuehu on 17/1/9.\n */\n\nvar api = {\n  getRemoteFile: function getRemoteFile(url) {\n    return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(\"/utils/getRemoteFile?url=\".concat(encodeURIComponent(url)));\n  },\n  getGatewayMachine: function getGatewayMachine() {\n    return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/utils/gateway/get-machine');\n  },\n  getConfigInfo: function getConfigInfo(deviceId) {\n    return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(\"/utils/gateway/config?deviceId=\".concat(deviceId));\n  },\n  setGateWay: function setGateWay(deviceId, config) {\n    return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(\"/utils/gateway/set?deviceId=\".concat(deviceId), config);\n  }\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (api);\n\n//# sourceURL=webpack:///./src/api/utils.js?");
...
/***/ "./src/monitor/components/device/devicelist.pcss":
/*!*******************************************************!*\
  !*** ./src/monitor/components/device/devicelist.pcss ***!
  \*******************************************************/
/*! no static exports found */
...
eval("// extracted by mini-css-extract-plugin\n\n//# sourceURL=webpack:///./src/monitor/components/device/devicelist.pcss?");
