<template>
    <div id="app"
        ...
        <div class="op-bar">
            <div class="buttons">
                <el-button @click="requestToggleRecordState"
                           v-if="!state.stopRecord"
                           type="danger"><i class="icon-stop"></i><span>停止</span></el-button>
                <el-button @click="requestToggleRecordState"
                           v-else
                           type="primary"
                           icon="caret-right">记录
